							...
							<div class="uabb-events-new">
								...
								<div class="uabb-events-inner-new">
									...
									<div class="uabb-timeline-content">
										...
										<?php if(!empty($settings->items[ $i ]->photo)){ ?>
											<div class="uabb-timeline-img">
												<?php echo wp_get_attachment_image((int)$settings->items[ $i ]->photo, 'large'); ?>
											</div>
										<?php } ?>
										...
										if ( '' !== $settings->items[ $i ]->heading ) {
											...
											<div class='uabb-timeline-date'>
												<p><?php echo wp_kses_post( ( 'date' === $settings->items[ $i ]->card_label_type ) ? $settings->items[ $i ]->date : $settings->items[ $i ]->label_text ); ?></p>
											</div>
